...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uja77ne.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uja77ne.containers.anotherwebservice.com/
...
```
git clone git@github.com:igor04091968/container-uja77ne.git
cd container-uja77ne
```
...
```
docker attach container-uja77ne
```
